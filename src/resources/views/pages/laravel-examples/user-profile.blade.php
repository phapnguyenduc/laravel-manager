<x-phapnguyenduc::layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <x-phapnguyenduc::navbars.sidebar activePage="user-profile"></x-phapnguyenduc::navbars.sidebar>
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        <!-- Navbar -->
        <x-phapnguyenduc::navbars.navs.auth titlePage='User Profile'></x-phapnguyenduc::navbars.navs.auth>
        <!-- End Navbar -->
