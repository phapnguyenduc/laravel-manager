...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="phapnguyenduc/laravel-manager/material/assets/img/apple-icon.png">
    <link rel="icon" type="image/png" href="phapnguyenduc/laravel-manager/material/assets/img/favicon.png">
    <title>
    ...
    <!-- Nucleo Icons -->
    <link href="phapnguyenduc/laravel-manager/css/nucleo-icons.css" rel="stylesheet" />
    <link href="phapnguyenduc/laravel-manager/css/nucleo-svg.css" rel="stylesheet" />
    <!-- Font Awesome Icons -->
    <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
    <!-- Material Icons -->
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Round" rel="stylesheet">
    <!-- CSS Files -->
    <link id="pagestyle" href="phapnguyenduc/laravel-manager/css/material-dashboard.css?v=3.0.0" rel="stylesheet" />
</head>
...
<body class="g-sidenav-show rtl bg-gray-200">
        ...
        <div class="sidenav-header">
            <i class="fas fa-times p-3 cursor-pointer text-white opacity-5 position-absolute start-0 top-0 d-none d-xl-none"
                ...
                <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
                    <img src="phapnguyenduc/laravel-manager/material/assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img src="phapnguyenduc/laravel-manager/material/assets/img/team-2.jpg"
                                                ...
                                                <div class="avatar-group mt-2">
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                        ...
                                                        <img alt="Image placeholder"
                                                            src="phapnguyenduc/laravel-manager/material/assets/img/team-1.jpg">
                                                    </a>
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                        title="Romina Hadid">
                                                        <img alt="Image placeholder"
                                                            src="phapnguyenduc/laravel-manager/material/assets/img/team-2.jpg">
                                                    </a>
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                        title="Alexander Smith">
                                                        <img alt="Image placeholder"
                                                            src="phapnguyenduc/laravel-manager/material/assets/img/team-3.jpg">
                                                    </a>
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                        title="Jessica Doe">
                                                        <img alt="Image placeholder"
                                                            src="phapnguyenduc/laravel-manager/material/assets/img/team-4.jpg">
                                                    </a>
                                                </div>
                                            </td>
    ...
    <!--   Core JS Files   -->
    <script src="phapnguyenduc/laravel-manager/js/core/popper.min.js"></script>
    <script src="phapnguyenduc/laravel-manager/js/core/bootstrap.min.js"></script>
    <script src="phapnguyenduc/laravel-manager/js/plugins/perfect-scrollbar.min.js"></script>
    <script src="phapnguyenduc/laravel-manager/js/plugins/smooth-scrollbar.min.js"></script>
    ...
    <script src="phapnguyenduc/laravel-manager/js/material-dashboard.min.js?v=3.0.0"></script>
</body>
