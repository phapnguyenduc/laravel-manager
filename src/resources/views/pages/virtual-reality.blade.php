<x-phapnguyenduc::layout bodyClass="g-sidenav-show  bg-gray-200 virtual-reality">

    <div class="mt-n3">
        <!-- Navbar -->
        <x-phapnguyenduc::navbars.navs.auth titlePage="Virtual Reality"></x-phapnguyenduc::navbars.navs.auth>
        <!-- End Navbar -->
    </div>
    <div class="border-radius-xl mx-2 mx-md-3 position-relative"
        style="background-image: url('phapnguyenduc/laravel-manager/material/assets/img/vr-bg.jpg'); background-size: cover;">
        <x-phapnguyenduc::navbars.sidebar activePage="virtual-reality"></x-phapnguyenduc::navbars.sidebar>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-auto">
                                    <img class="w-50 float-end mt-n6 mt-lg-n4"
                                        src="phapnguyenduc/laravel-manager/material/assets/img/small-logos/icon-sun-cloud.png" alt="image sun">
                                </div>
                            </div>
                            <div class="row mt-4">
