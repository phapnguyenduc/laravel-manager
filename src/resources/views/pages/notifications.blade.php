<x-phapnguyenduc::layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <x-phapnguyenduc::navbars.sidebar activePage="notifications"></x-phapnguyenduc::navbars.sidebar>
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-phapnguyenduc::navbars.navs.auth titlePage="Notifications"></x-phapnguyenduc::navbars.navs.auth>
        <!-- End Navbar -->
