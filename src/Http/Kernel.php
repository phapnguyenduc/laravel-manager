...
namespace PhapNguyenDuc\LaravelManager\Http;
...
use PhapNguyenDuc\LaravelManager\Http\Middleware\PreventRequestsDuringMaintenance;
use PhapNguyenDuc\LaravelManager\Http\Middleware\RedirectIfAuthenticated;
use PhapNguyenDuc\LaravelManager\Http\Middleware\TrimStrings;
use PhapNguyenDuc\LaravelManager\Http\Middleware\TrustProxies;
